...
def create_type_cases_table(dialect, table_name: str = "type_cases") -> CreateTableExpression:
    return CreateTableExpression(
        ...
        columns=[
            ...
            ColumnDefinition(dialect, "char_val", VarCharType(255, dialect=dialect)),
            ColumnDefinition(dialect, "varchar_val", VarCharType(255, dialect=dialect)),
...
def create_type_tests_table(dialect, table_name: str = "type_tests") -> CreateTableExpression:
    return CreateTableExpression(
        ...
        columns=[
            ColumnDefinition(dialect, "id", PostgresUUIDType(dialect=dialect),
                constraints=[ColumnConstraint(dialect, ColumnConstraintType.NOT_NULL)]),
            ColumnDefinition(dialect, "string_field", VarCharType(255, dialect=dialect),
                constraints=[ColumnConstraint(dialect, ColumnConstraintType.NOT_NULL)]),
            ...
            ColumnDefinition(dialect, "nullable_field", VarCharType(255, dialect=dialect)),
        ],
        table_constraints=[
            TableConstraint(dialect, constraint_type=TableConstraintType.PRIMARY_KEY,
                columns=["id"]),
...
def create_validated_users_table(dialect, table_name: str = "validated_users") -> CreateTableExpression:
    return CreateTableExpression(
        ...
        columns=[
            ColumnDefinition(dialect, "id", PostgresSerialType(dialect=dialect),
                constraints=[ColumnConstraint(dialect, ColumnConstraintType.PRIMARY_KEY)]),
            ColumnDefinition(dialect, "username", VarCharType(50, dialect=dialect),
                constraints=[ColumnConstraint(dialect, ColumnConstraintType.NOT_NULL)]),
            ColumnDefinition(dialect, "email", VarCharType(255, dialect=dialect),
                constraints=[ColumnConstraint(dialect, ColumnConstraintType.NOT_NULL)]),
            ColumnDefinition(dialect, "age", IntegerType(dialect=dialect)),
...
def create_pydantic_validated_models_table(dialect, table_name: str = "pydantic_validated_models") -> CreateTableExpression:
    return CreateTableExpression(
        ...
        columns=[
            ColumnDefinition(dialect, "id", PostgresSerialType(dialect=dialect),
                constraints=[ColumnConstraint(dialect, ColumnConstraintType.PRIMARY_KEY)]),
            ColumnDefinition(dialect, "code", VarCharType(32, dialect=dialect)),
            ...
            ColumnDefinition(dialect, "status", VarCharType(32, dialect=dialect)),
            ColumnDefinition(dialect, "normalized_name", VarCharType(50, dialect=dialect)),
            ColumnDefinition(dialect, "created_token", VarCharType(255, dialect=dialect)),
        ],
    )
...
def create_type_adapter_tests_table(dialect, table_name: str = "type_adapter_tests") -> CreateTableExpression:
    return CreateTableExpression(
        ...
        columns=[
            ...
            ColumnDefinition(dialect, "name", VarCharType(255, dialect=dialect),
                constraints=[ColumnConstraint(dialect, ColumnConstraintType.NOT_NULL)]),
            ColumnDefinition(dialect, "optional_name", VarCharType(255, dialect=dialect)),
            ...
            ColumnDefinition(dialect, "unsupported_union", VarCharType(255, dialect=dialect)),
            ColumnDefinition(dialect, "custom_bool", VarCharType(10, dialect=dialect)),
            ColumnDefinition(dialect, "optional_custom_bool", VarCharType(10, dialect=dialect)),
        ],
    )
...
def create_store_inventory_table(dialect, table_name: str = "store_inventory") -> CreateTableExpression:
    return CreateTableExpression(
        ...
        columns=[
            ...
            ColumnDefinition(dialect, "product_id", IntegerType(dialect=dialect),
                constraints=[ColumnConstraint(dialect, ColumnConstraintType.NOT_NULL)]),
            ColumnDefinition(dialect, "batch_id", VarCharType(64, dialect=dialect),
                constraints=[ColumnConstraint(dialect, ColumnConstraintType.NOT_NULL)]),
