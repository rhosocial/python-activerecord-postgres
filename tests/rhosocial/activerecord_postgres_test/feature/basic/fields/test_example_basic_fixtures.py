# tests/rhosocial/activerecord_postgres_test/feature/basic/fields/test_example_basic_fixtures.py
"""
Bridge file for example basic fixtures tests from the testsuite.
"""
