# tests/rhosocial/activerecord_postgres_test/feature/query/test_relations_complex.py
"""
Complex relations functionality tests for postgres backend.
...
from rhosocial.activerecord.testsuite.feature.query.test_relations_complex import *
