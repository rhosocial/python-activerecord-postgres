# tests/rhosocial/activerecord_postgres_test/feature/query/test_cte_integration.py
"""
CTE integration functionality tests for postgres backend.
...
from rhosocial.activerecord.testsuite.feature.query.test_cte_integration import *
