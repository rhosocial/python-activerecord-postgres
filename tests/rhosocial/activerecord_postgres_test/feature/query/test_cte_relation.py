# tests/rhosocial/activerecord_postgres_test/feature/query/test_cte_relation.py
"""
CTE relation functionality tests for postgres backend.
...
from rhosocial.activerecord.testsuite.feature.query.test_cte_relation import *
