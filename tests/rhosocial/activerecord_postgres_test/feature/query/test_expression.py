# tests/rhosocial/activerecord_postgres_test/feature/query/test_expression.py
"""
Expression functionality tests for postgres backend.
...
from rhosocial.activerecord.testsuite.feature.query.test_expression import *
