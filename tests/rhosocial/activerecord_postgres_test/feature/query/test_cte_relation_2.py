# tests/rhosocial/activerecord_postgres_test/feature/query/test_cte_relation_2.py
"""
CTE relation 2 functionality tests for postgres backend.
...
from rhosocial.activerecord.testsuite.feature.query.test_cte_relation_2 import *
