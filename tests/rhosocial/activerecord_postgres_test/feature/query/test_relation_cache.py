# tests/rhosocial/activerecord_postgres_test/feature/query/test_relation_cache.py
"""
Relation cache functionality tests for postgres backend.
...
from rhosocial.activerecord.testsuite.feature.query.test_relation_cache import *
