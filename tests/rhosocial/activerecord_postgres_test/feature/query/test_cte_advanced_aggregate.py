# tests/rhosocial/activerecord_postgres_test/feature/query/test_cte_advanced_aggregate.py
"""
CTE advanced aggregate functionality tests for postgres backend.
...
from rhosocial.activerecord.testsuite.feature.query.test_cte_advanced_aggregate import *
