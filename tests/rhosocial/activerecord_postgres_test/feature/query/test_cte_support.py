# tests/rhosocial/activerecord_postgres_test/feature/query/test_cte_support.py
"""
CTE support functionality tests for postgres backend.
...
from rhosocial.activerecord.testsuite.feature.query.test_cte_support import *
