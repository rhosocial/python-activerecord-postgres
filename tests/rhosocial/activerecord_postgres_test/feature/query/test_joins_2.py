# tests/rhosocial/activerecord_postgres_test/feature/query/test_joins_2.py
"""
Query joins 2 functionality tests for postgres backend.
...
from rhosocial.activerecord.testsuite.feature.query.test_joins_2 import *
