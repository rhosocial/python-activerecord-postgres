# tests/rhosocial/activerecord_postgres_test/feature/query/test_cte_aggregate.py
"""
CTE aggregate functionality tests for postgres backend.
...
from rhosocial.activerecord.testsuite.feature.query.test_cte_aggregate import *
