# tests/rhosocial/activerecord_postgres_test/feature/query/test_relations_with_query.py
"""
Relations with query functionality tests for postgres backend.
...
from rhosocial.activerecord.testsuite.feature.query.test_relations_with_query import *
