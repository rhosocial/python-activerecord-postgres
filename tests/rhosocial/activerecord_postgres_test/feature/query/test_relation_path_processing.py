# tests/rhosocial/activerecord_postgres_test/feature/query/test_relation_path_processing.py
"""
Relation path processing functionality tests for postgres backend.
...
from rhosocial.activerecord.testsuite.feature.query.test_relation_path_processing import *
