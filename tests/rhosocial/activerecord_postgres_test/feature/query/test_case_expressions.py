# tests/rhosocial/activerecord_postgres_test/feature/query/test_case_expressions.py
"""
Case expressions functionality tests for postgres backend.
...
from rhosocial.activerecord.testsuite.feature.query.test_case_expressions import *
