# tests/rhosocial/activerecord_postgres_test/feature/query/test_cte_window.py
"""
CTE window functions functionality tests for postgres backend.
...
from rhosocial.activerecord.testsuite.feature.query.test_cte_window import *
