# tests/rhosocial/activerecord_postgres_test/feature/query/test_cte_recursive.py
"""
Recursive CTE functionality tests for postgres backend.
...
from rhosocial.activerecord.testsuite.feature.query.test_cte_recursive import *
