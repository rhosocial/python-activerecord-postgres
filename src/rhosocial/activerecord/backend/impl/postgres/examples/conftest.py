...
'insert/batch.py': {
    ...
    'schema_diff/column_order_irrelevant.py': {
        'title': 'Schema Diff — Column Order Is Ignored',
        'dialect_protocols': [],
        'priority': 10,
        'min_version': '9',
        'max_version': '18',
    },
    'schema_diff/postgres10_identity.py': {
        'title': 'Schema Diff — PG9 SERIAL vs PG10+ IDENTITY',
        'dialect_protocols': [],
        'priority': 10,
        'min_version': '9',
        'max_version': '18',
    },
    'schema_diff/array_type_diff.py': {
        'title': 'Schema Diff — Array Type Dimension Changes',
        'dialect_protocols': [],
        'priority': 10,
        'min_version': '9',
        'max_version': '18',
    },
    'schema_diff/index_type_diff.py': {
        'title': 'Schema Diff — PostgreSQL Index Type Switches',
        'dialect_protocols': [],
        'priority': 10,
        'min_version': '9',
        'max_version': '18',
