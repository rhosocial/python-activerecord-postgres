...
'insert/batch.py': {
    ...
    'extensions/postgis.py': {
        'title': 'Spatial Data and Geographic Objects',
        'dialect_protocols': [],
        'priority': 5,
        'min_version': '9',
        'max_version': '18',
    ...
    'extensions/citext.py': {
        'title': 'Case-Insensitive Text Type',
        'dialect_protocols': [],
        'priority': 5,
        'min_version': '9',
        'max_version': '18',
    ...
    'extensions/ltree.py': {
        'title': 'Hierarchical Path Data Type',
        'dialect_protocols': [],
        'priority': 5,
        'min_version': '9',
        'max_version': '18',
    ...
    'extensions/cube.py': {
        'title': 'Multi-Dimensional Cube Data Type',
        'dialect_protocols': [],
        'priority': 5,
        'min_version': '9',
        'max_version': '18',
    },
    'extensions/earthdistance.py': {
        'title': 'Geographic Distance Calculations',
        'dialect_protocols': [],
        'priority': 5,
        'min_version': '9',
        'max_version': '18',
        'note': 'Depends on cube extension',
    },
    'extensions/fuzzystrmatch.py': {
    ...
    'extensions/intarray.py': {
        'title': 'Integer Array Operations and Indexing',
        'dialect_protocols': [],
        'priority': 5,
        'min_version': '9',
        'max_version': '18',
    },
    'extensions/pg_trgm.py': {
        'title': 'Trigram-Based Fuzzy Text Search',
        'dialect_protocols': [],
        'priority': 5,
        'min_version': '9',
        'max_version': '18',
    },
    'extensions/uuid_ossp.py': {
    ...
    'extensions/amcheck.py': {
        'title': 'Index Integrity Checking',
        'dialect_protocols': [],
        'priority': 3,
        'min_version': '9',
        'max_version': '18',
    ...
    'extensions/pageinspect.py': {
        'title': 'Page-Level Database Inspection',
        'dialect_protocols': [],
        'priority': 3,
        'min_version': '9',
        'max_version': '18',
    },
    'extensions/pg_logicalinspect.py': {
        'title': 'Logical Replication Inspection',
        'dialect_protocols': [],
        'priority': 3,
        'min_version': '18',
        'max_version': '18',
        'note': 'Only available in PostgreSQL 18+ docker images',
    },
}
