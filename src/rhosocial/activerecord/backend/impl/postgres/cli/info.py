...
from rhosocial.activerecord.backend.impl.postgres.protocols import (
    ...
    # Per-feature protocol imports replacing PostgresSQLSyntaxSupport
    PostgresCTESupport,
...
PROTOCOL_FAMILY_GROUPS: Dict[str, list] = {
    ...
    "PostgreSQL Native": [
        ...
        PostgresCTESupport, PostgresWindowSupport,
        PostgresFilterSupport, PostgresReturningSupport,
        PostgresGroupingSupport, PostgresExplainSupport,
        PostgresMergeSupport, PostgresUpsertSupport,
        PostgresLateralJoinSupport, PostgresSetOperationSupport,
        PostgresILIKESupport, PostgresJoinSupport,
        PostgresTruncateSupport, PostgresSchemaSupport,
        PostgresSequenceSupport, PostgresTransactionSupport,
        PostgresViewSupport, PostgresXMLSupport,
        PostgresCollationSupport, PostgresOrderedSetAggSupport,
        PostgresFeaturesSupport,
    ],
